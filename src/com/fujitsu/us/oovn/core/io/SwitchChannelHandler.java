...
public class SwitchChannelHandler extends ChannelHandlerAdapter
{
    Logger logger = LoggerFactory.getLogger(SwitchChannelHandler.class);
    ...
    enum ChannelState
    {
        ...
        WAIT_HELLO(false)
        {
            ...
            void processOFError(final SwitchChannelHandler h, final OFError m)
            {
                h.logger.error("Error waiting for Hello (type:{}, code:{})",
         ...
         * received. To be used as message for SwitchStateException or logger
         * messages
         *
         * @param h
        ...
        protected void unhandledMessageReceived(final SwitchChannelHandler h,
                final OFMessage m)
        {
            h.logger.warn(this.getSwitchStateMessage(h, m,
    ...
    public SwitchChannelHandler(final Server ctrl)
    {
        this.ctrl = ctrl;
        this._state = ChannelState.INIT;
        this.pendingPortStatusMsg = new ArrayList<OFPortStatus>();
    }

    public boolean isHandShakeComplete()
    {
        return _state.isHandShakeComplete();
    }
                ...
                try
                {
                    ...
                    case PACKET_IN:
                        ...
                        if(OVXLLDP.isLLDP(data))
                        {
                            ...
                            {
                                this.logger.warn("Switch has not connected yet; dropping LLDP for now");
                            }
                            break;
                        }
                    default:
                        // Process all non-packet-ins
                        this._state.processOFMessage(this, ofm);
                        break;
                    }
            ...
            final ExceptionEvent e) throws Exception
    {
        ...
        else
        {
            logger.error(
                    ...
                    this.getSwitchInfoString(), this._state, e.getCause());
